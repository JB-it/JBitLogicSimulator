class FullAdder {
    ...
    show() {
        ...
        fill(255);
        text('A',  this.xPosition + 4,  this.yPosition + 28);
        text('B',  this.xPosition + 4,  this.yPosition + 55);
        text('C',  this.xPosition + 4,  this.yPosition + 79);
